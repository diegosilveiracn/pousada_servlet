...
<html>
    ...
    <body leftmargin='15' topmargin='15' marginleft='15' marginleft='15' bgcolor='#ffffff'>
        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <div><div><div style="display:none;">
                <ul id="imenus0" style="width:580px">
                    ...
                    <li  style="width:145px;">
                        ...
                        <div>
                            <div style="width:146px;top:4px;left:-1px;"><ul style="">
                                <li ><a href="/POUSADA/main/menu/StatusApRel.jps" target="_self"> - Apartamentos por Status</a></li>
                            </ul>
                            </div>
                        </div>
                    </li>
            ...
            <p><fieldset >
                <font size="2"><legend>Desenvolvedores</legend>
                </font>
                <div style="color:#000000; font-size:13px; font-family:Arial; font-weight:bold;">- Denis Roberto Costa Lima</div>
                <div style="color:#000000; font-size:13px; font-family:Arial; font-weight:bold;">- Diego Silveira Costa Nascimento</div>
