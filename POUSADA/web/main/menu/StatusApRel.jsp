        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <p>
                <script language="JavaScript">
                    ...
                    function verifica(){
                    if(document.form1.lstStatus.value==""){
                    alert("Escolha um dos status!");
                    document.form1.lstStatus.focus();
                    return false;
                    }
            ...
            <p><fieldset >
                ...
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerReportServlet">
                    <input type="hidden" name="cmd" value="StatusApRel">
                    <table width="59%" border="0">
                        <tr>
                            <td width="30%">
                                <font size="2" style="width:146px;top:4px;left:0px;">Status:</font>
                            </td>
                            <td width="42%">
                            ...
                            <td width="30%">
                                <font size="2" style="width:146px;top:4px;left:0px;">Data:</font>
                            </td>                            
                            <td width="30%">
                                <font size="2" style="width:146px;top:4px;left:0px;">
                                    <input type="text" name="edtData">
                                </font>
                            </td>
                            <td width="28%">&nbsp;</td>
                        </tr>
