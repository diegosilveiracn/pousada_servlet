...
<html>
    ...
    <body leftmargin='15' topmargin='15' marginleft='15' marginleft='15' bgcolor='#ffffff'>
                    ...
                    <div style="display:none;">
                        <ul id="imenus0" style="width:580px">
                            <li  style="width:145px;">
                                ...
                                <div>
                                    <div style="width:145px;top:4px;left:0px;"><ul style="">
                            ...
                            <li  style="width:145px;">
                                ...
                                <div>
                                    <div style="width:146px;top:4px;left:-1px;">
                                        <ul style="">
                                            <li ><a href="/POUSADA/" target="_self"> - Apartamentos por Status</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
            ...
            <p>
                <script language="JavaScript">
                    ...
                    function verifica(obj){
                      camposObrigatorio = true; 
                      
                      if(obj.value == "btnOcupar"){
                         ...
                         if(document.form1.cmbTipoClienteAp.value==""){
                             alert("Informe o tipo de cliente!");
                             document.form1.cmbTipoClienteAp.focus();
                             camposObrigatorio = false;       
                          }   
                          
                          if(document.form1.txtQtdDias.value==""){
                             alert("Informe a quantidade de dias de ocupação!");
                             document.form1.cmbTipoClienteAp.focus();
                             camposObrigatorio = false;       
                          }   
                    ...
                    function mudarEstado(){
                       ...
                       document.form1.cmbTipoClienteAp.value="";
                       document.form1.txtQtdDias.value="";
                       
                       if(document.form1.cmbNumeroAp.value == ""){
                          document.form1.btnOcupar.disabled = false;
                          document.form1.btnDesocupar.disabled = true;
                          document.form1.txtNumeroAp.disabled = false;
                          document.form1.cmbTipoClienteAp.disabled = false;
                          document.form1.txtQtdDias.disabled = false;
                          document.form1.acao.value="Ocupar";
                       }else{
                          document.form1.btnOcupar.disabled = true;
                          document.form1.btnDesocupar.disabled = false;
                          document.form1.txtNumeroAp.disabled = true;
                          document.form1.cmbTipoClienteAp.disabled = true;
                          document.form1.txtQtdDias.disabled = true;
                          document.form1.acao.value="Desocupar";
                       }
                    }
                </script>
            </p>
            <p><fieldset >
                <font size="2"><legend>Apartamento</legend>
                </font>
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerServlet">
                    <input type="hidden" name="cmd" value="ocuparAp">
                    <input type="hidden" name="acao" value="">
                    <table width="59%" border="0">
                        <tr>
                            <td width="30%">
                                <font size="2" style="width:146px;top:4px;left:0px;">Ocupados
                                :</font>
                            </td>
                            <td width="42%">
                        ...
                        <tr>
                            <td width="30%">
                                <font size="2" style="width:146px;top:4px;left:0px;">Número:</font>
                            </td>
                            <td width="42%">
                                <font size="2" style="width:145px;">
                                    <input type="text" name="txtNumeroAp" size="20">
                                </font>
                            </td>
                            <td width="28%">
                                <font size="2" style="width:145px;">&nbsp;</font>
                                <font size="2">
                                    <input type="button" name="btnOcupar" value="Ocupar" onClick="verifica(this);">
                                </font>
                                <font size="2" style="width:145px;">&nbsp;</font>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <font size="2" style="width:146px;top:4px;left:0px;">Tipo de Cliente:</font>
                            </td>
                            <td>
                                <font size="2">
                                    <select name="cmbTipoClienteAp">
                            ...
                            <td>
                                <font size="2">
                                    <input type="button" name="btnDesocupar" value="Desocupar" onClick="verifica(this);">
                                </font>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <font size="2" style="width:146px;top:4px;left:0px;">Dias de Ocupação:</font>
                            </td>
                            <td>
                                <font size="2">
                                    <input type="text" name="txtQtdDias" size="20">
                                </font>
                            </td>
                            <td>
                                <font size="2">
        ...
        <a href="/POUSADA/" style="text-decoration:none;"><div style="color:#111111; font-size:10px; text-decoration:none; font-family:Arial;">Organizações Tabajara Copyright, 2006. All Rights Reserved.</div></a>
