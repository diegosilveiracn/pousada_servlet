    ...
    <body leftmargin='15' topmargin='15' marginleft='15' marginleft='15' bgcolor='#ffffff'>
        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <ul id="imenus0" style="width:580px">
                ...
                <div><div style="width:145px;top:4px;left:0px;"><ul style="">
                    <li ><a href="/POUSADA/main/menu/cadastrarAp.jsp" target="_self"> - Cadastro de Apartamentos</a></li>
                </ul></div></div></li>

                <li  style="width:145px;"><a href="#" target="_self">Operações</a>
                ...
                <li  style="width:145px;"><a href="#" target="_self">Consultas</a>
                    ...
                    <div><div style="width:146px;top:4px;left:0px;"><ul style="">
                        ...
                        <li ><a href="/POUSADA/main/menu/comsumoAp.jsp" target="_self"> - Consumo do Apartamento</a></li>
                    </ul>
                    </div>
                    </div>
                </li>

                <li  style="width:145px;"><a href="#" target="_self">Relatórios</a>

                    <div>
                        <div style="width:146px;top:4px;left:-1px;"><ul style="">
                ...
                <li  style="width:145px;"><a href="#" target="_self">Sobre</a>
            ...
            <p><fieldset >
                ...
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerServlet">
                    <input type="hidden" name="cmd" value="totalPagarAp">
                    <table width="59%" border="0">
                        <tr>
                            <td width="30%"><font size="2" style="width:146px;top:4px;left:0px;">N&uacute;mero
                            :</font></td>
                            <td width="42%"><font size="2" style="width:145px;">
                                <input name="txtNumeroAp" type="text" id="txtNumeroAp" size="20">
                            </font></td>
                            <td width="28%"><font size="2" style="width:145px;">&nbsp;
                            </font><font size="2">
                                <input name="btnCadastrar" type="submit" id="btnCadastrar3" value="Consultar" onClick="return verifica();">
                            </font><font size="2" style="width:145px;">&nbsp;    </font></td>
                        </tr>
                    </table>
                </form>
            </fieldset>&nbsp;</p>
