        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <div>
                <div>
                    <div style="display:none;"><ul id="imenus0" style="width:580px">
                        <li  style="width:145px;"><a href="#" target="_self">Cadastro</a>
            ...
            <p>
                <script language="JavaScript">
                    ...
                    if(document.form1.txtNumeroAp.value==""){
                     ...
                     if(document.form1.txtQuantidadeConsumo.value==""){
                        alert("Escolha uma das opções do campo Valor do Consumo!");
                        document.form1.txtQuantidadeConsumo.focus();
                        return false;
                     }
                    }
            ...
            <fieldset >
                ...
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerServlet">
                    <input type="hidden" name="cmd" value="adicionarConsumoAp">
                    <table width="59%" border="0">
                        ...
                        <tr>
                            <td><font size="2" style="width:146px;top:4px;left:0px;">Valor do Consumo
                            :</font></td>
                            <td><font size="2">
                                <input name="txtQuantidadeConsumo" type="text" id="txtValorDiaria2" size="20">
                            </font></td>
                            <td><font size="2">
