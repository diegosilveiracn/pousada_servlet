<%@ taglib prefix="ap" uri="/WEB-INF/classes/tlds/mapeamentoTagLib" %>
<%@page import="java.util.Vector"%>
<%@page import="tabajara.*"%>
...
<html>
    ...
    <body leftmargin='15' topmargin='15' marginleft='15' marginleft='15' bgcolor='#ffffff'>
        ...
        <img src="/POUSADA/main/menu/images/parajuru.jpg" width="752" height="124"></div>
        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <div>
                <div>
                    <div style="display:none;"><ul id="imenus0" style="width:580px">
            ...
            <p>
                <script language="JavaScript">
                    ...
                    function verifica(){
                       if(document.form1.txtNumeroAp.value=="") {
                          alert("Preencha o campo Número!");
                          document.form1.txtNumeroAp.focus();
                          return false;
                       } 
                       if(document.form1.cmbModeloAp.value==""){
                          alert("Escolha uma das opções do campo Modelo!");
                          document.form1.cmbModeloAp.focus();
                          return false;
                       }
                       if(document.form1.cmbTipoAp.value==""){
                          alert("Escolha uma das opções do campo Tipo!");
                          document.form1.cmbTipoAp.focus();
                          return false;
                       }
                    if(document.form1.txtValorDiaria.value=="")
                    {
                    alert("Escolha uma das opções do campo Valor Diária!");
                    document.form1.txtValorDiaria.focus();
                    return false;
                    } 
                    }
                    ...
                    function mudarEstado(){
                       ...
                       if(document.form1.cmbNumeroAp.value == ""){
                            document.form1.btnExcluir.disabled = true;
                            document.form1.btnCadastrar.disabled = false;
                            document.form1.txtNumeroAp.disabled = false;
                            document.form1.cmbModeloAp.disabled = false;
                            document.form1.cmbTipoAp.disabled = false;
                            document.form1.txtValorDiaria.disabled = false;
                            document.form1.acao.value="Cadastrar";
                       }else{
                            document.form1.btnExcluir.disabled = false;
                            document.form1.btnCadastrar.disabled = true;
                            document.form1.txtNumeroAp.disabled = true;
                            document.form1.cmbModeloAp.disabled = true;
                            document.form1.cmbTipoAp.disabled = true;
                            document.form1.txtValorDiaria.disabled = true;                            
                            document.form1.acao.value="Excluir";
                       }
                       document.form1.txtNumeroAp.value="";
                       document.form1.cmbModeloAp.value="";
                       document.form1.cmbTipoAp.value="";
                       document.form1.txtValorDiaria.value="";
                    }
                </script>
            </p>
            <p>
            <fieldset>
                ...
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerServlet">
                    <input type="hidden" name="cmd" value="cadastrarAp">
                    <input type="hidden" name="acao" value="">
                    <table width="59%" border="0">
                        <tr>
                            <td width="25%">
                                <font size="2" style="width:146px;top:4px;left:0px;">Cadastrados
                                :</font>
                            </td>
                            <td width="47%">
                                <font size="2" style="width:145px;">
                                  <select name="cmbNumeroAp"  onChange="mudarEstado()">
                        ...
                        <tr>
                            <td width="25%">
                                <font size="2" style="width:146px;top:4px;left:0px;">N&uacute;mero
                                :</font>
                            </td>
                            <td width="47%">
                                <font size="2" style="width:145px;">
                                    <input name="txtNumeroAp" type="text" id="txtNumeroAp" size="20">
                                </font>
                            </td>
                            <td width="28%">
                                <font size="2" style="width:145px;">&nbsp;
                        ...
                        <tr>
                            <td>
                                <font size="2" style="width:146px;top:4px;left:0px;">Modelo :</font>
                            </td>
                            <td>
                                <select name="cmbModeloAp" id="select">
                                    <option>&lt;&lt;Escolha o Modelo&gt;&gt;
                                    <option value="1">SOLTEIRO
                                    <option value="2">DUPLO
                                    <option value="3">CHALE
                                </select>
                            </td>
                            <td>
                                <font size="2">
                                    <input name="btnCadastrar" type="submit" id="btnCadastrar2" value="Cadastrar" onClick="return verifica();">
                                </font>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <font size="2" style="width:146px;top:4px;left:0px;">Tipo :</font>
                            </td>
                            <td>
                                <font size="2">
                                    <select name="cmbTipoAp" id="select2">
                                        <option> &lt;&lt;Escolha o Tipo&gt;&gt;
                                        <option value="1">STANDARD
                                        <option value="2">LUXO
                                        <option value="3">EXECUTIVO
                                    </select>
                                </font>
                            </td>
                            <td>
                                <font size="2">
                                    <input name="btnExcluir" type="submit" id="btnExcluir2" value="   Excluir   ">
                                </font>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <font size="2" style="width:146px;top:4px;left:0px;">Valor Di&aacute;ria
                                :</font>
                            </td>
                            <td>
                                <font size="2">
                                    <input name="txtValorDiaria" type="text" id="txtValorDiaria2" size="20">
                                </font>
                            </td>
                            <td>
                                <font size="2">
        ...
        <a href="/POUSADA/index.jsp" style="text-decoration:none;">
        <div style="color:#111111; font-size:10px; text-decoration:none; font-family:Arial;">Organizações Tabajara Copyright, 2006. All Rights Reserved.</div></a>
