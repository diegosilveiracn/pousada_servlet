...
<html>
    ...
    <body leftmargin='15' topmargin='15' marginleft='15' marginleft='15' bgcolor='#ffffff'>
        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <p><fieldset >
                <font size="2"><legend>Apartamentos</legend>
                </font>
                <form name="form1" action="/POUSADA/servlet/FrontControllerReportServlet" method="post">
                    <input type="hidden" name="cmd" value="StatusApRel">
