        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <p>
                <script language="JavaScript">
                    ...
                    function verifica(){
                       ...
                       if(document.form1.txtQuantidadeCamasAp.value==""){
                          alert("Escolha uma das opções do campo Número de Camas!");
                          document.form1.txtQuantidadeCamasAp.focus();
                          return false;
                       }
                    }
            ...
            <p><fieldset >
                ...
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerServlet">
                    <input type="hidden" name="cmd" value="adicionarCamasAp">
                    <table width="59%" border="0">
                        ...
                        <tr>
                            <td><font size="2" style="width:146px;top:4px;left:0px;">N&uacute;mero de Camas
                            :</font></td>
                            <td><font size="2">
                                <input name="txtQuantidadeCamasAp" type="text" id="txtValorDiaria2" size="20">
                            </font></td>
                            <td><font size="2">
