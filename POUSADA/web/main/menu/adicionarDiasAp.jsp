        ...
        <div style="padding:30px;padding-bottom:300px;">
            ...
            <p>
                <script language="JavaScript">
                    ...
                    if(document.form1.txtQuantidadeDiasAp.value=="")
                    {
                    alert("Escolha uma das opções do campo Dias de Ocupação!");
                    document.form1.txtQuantidadeDiasAp.focus();
                    return false;
                    }
                    }
            ...
            <p><fieldset >
                ...
                <form name="form1" method="post" action="/POUSADA/servlet/FrontControllerServlet">
                    <input type="hidden" name="cmd" value="adicionarDiasAp">
                    <table width="59%" border="0">
                        <tr>
                            ...
                            <td width="28%"><font size="2" style="width:145px;">&nbsp;
                                ...
                                <input name="btnCadastrar" type="submit" id="btnCadastrar3" value="Adicionar" onClick="return verifica();">
                            </font><font size="2" style="width:145px;">&nbsp;    </font></td>
                        </tr>
                        <tr>
                            <td><font size="2" style="width:146px;top:4px;left:0px;">N&uacute;mero de
                            Dias :</font></td>
                            <td><font size="2">
                                <input name="txtQuantidadeDiasAp" type="text" id="txtQuantidadeDiasAp" size="20">
                            </font></td>
                            <td><font size="2">
